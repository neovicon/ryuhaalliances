...
export async function createPost(req, res) {
    ...
    await post.populate('author', 'username displayName photoUrl house memberStatus');
...
export async function listPosts(req, res) {
    ...
    const posts = await GodDomainPost.find(query)
        .populate('author', 'username displayName photoUrl house memberStatus')
        .populate('comments.author', 'username displayName photoUrl house memberStatus')
        .sort({ createdAt: -1 })
...
export async function addComment(req, res) {
    ...
    await post.populate('author', 'username displayName photoUrl house memberStatus');
    await post.populate('comments.author', 'username displayName photoUrl house memberStatus');
