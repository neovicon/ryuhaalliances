...
const houses = ['Pendragon', 'Phantomhive', 'Tempest', 'Zoldyck', 'Fritz', 'Elric', 'Hellsing', 'Obsidian Order', 'Council of IV', 'Abyssal IV', 'Von Einzbern', 'Vermillion'];

const memberStatuses = ['Creator of the Realm', 'Guardian', 'Lord of the House', 'General', 'Saint', 'Seeker', 'Herald', 'Watcher', 'Knight of Genesis', 'Knight of I', 'Knight of II', 'Knight of III', 'Knight of IV', 'Knight of V', 'Commoner', 'Shopkeeper', 'Blacksmith', 'Garrison'];
