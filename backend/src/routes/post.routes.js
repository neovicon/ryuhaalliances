...
import { addComment, createPost, listPosts, react, removePost, validateComment, validateCreatePost, validateDelete, validateReact } from '../controllers/post.controller.js';
